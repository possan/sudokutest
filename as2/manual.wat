(module
 ...
 (global $as/index/target (mut i32) (i32.const 0))
 (global $as/index/randomTable (mut i32) (i32.const 0))
 (global $as/index/randomIndex (mut i32) (i32.const 0))
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 18036))
 (memory $0 1)
 (data (i32.const 1036) ",")
 ...
 (export "randomizeOneBoardWasmMultiple" (func $as/index/randomizeOneBoardWasmMultiple))
 (export "memory" (memory $0))
 (start $~start)
 (func $as/index/addTwo (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  i32.add
 )
 ...
 (func $~lib/rt/itcms/visitRoots
  (local $0 i32)
  (local $1 i32)
  global.get $as/index/target
  local.tee $0
  if
   local.get $0
   call $~lib/rt/itcms/__visit
  end
  global.get $as/index/randomTable
  local.tee $0
  if
   local.get $0
   call $~lib/rt/itcms/__visit
 ...
 (func $as/index/Board#set:cells (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store offset=8
  local.get $0
      ...
      block $~lib/arraybuffer/ArrayBufferView
       block $~lib/string/String
        block $~lib/arraybuffer/ArrayBuffer
         ...
         i32.sub
         i32.load
         br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $as/index/Board $~lib/staticarray/StaticArray<u32> $~lib/array/Array<u32> $invalid
        end
        return
       end
       return
 ...
 (func $as/index/initRandomTable
  ...
  global.set $~lib/memory/__stack_pointer
  local.get $2
  global.set $as/index/randomTable
  loop $for-loop|0
   local.get $1
   i32.const 1000
   i32.lt_s
 ...
 (func $as/index/random (result i32)
  (local $0 i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  ...
  i32.const 0
  i32.store
  global.get $as/index/randomIndex
  i32.const 1
  i32.add
  global.set $as/index/randomIndex
  global.get $~lib/memory/__stack_pointer
  global.get $as/index/randomTable
  local.tee $0
  i32.store
 ...
 (func $as/index/fillDefaultBoard
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $as/index/_swapRows (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $as/index/_swapColumns (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $as/index/createBoard (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $as/index/randomizeOneBoardWasm (param $0 i32) (param $1 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
  ...
  i32.const 0
  i32.store
  call $as/index/initRandomTable
  global.get $~lib/memory/__stack_pointer
  local.get $0
  local.get $1
  call $as/index/createBoard
  local.tee $0
  i32.store
  local.get $0
  global.set $as/index/target
  call $as/index/fillDefaultBoard
  call $as/index/shuffleBoard
  local.get $0
  i32.load offset=8
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $as/index/randomizeOneBoardWasmMultiple (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
